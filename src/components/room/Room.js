...
const Room = (props) => {
    ...
    return (
        ...
        <CssBaseline />
            <Grid container direction="row" justify="space-around" alignItems="stretch" style={{height:'100vh'}} alignContent="stretch">
                <Grid
                    container
                    ...
                    alignItems="flex-end"
                    style={{backgroundColor:'#090A0Bff',color:'#f6f5f4ff'}}
                    >
                    <Grid
                    container
                    item xs={12}
                    ...
                    >
                        ...
                        <video style={{width: '90%'}} muted  ref={userVideo} autoPlay playsInline />
                        <h4>You</h4>
                        </Grid>
                    ...
                    <Sidebar avatar={{userId:props.userId,name:props.name}} messages={messages} leave={()=>{socketRef.current.disconnect()}} inviteUrl={window.location.href} onCopyInvite={()=>handleSnackClick("Invite link copied to clipboard")} sendMessage={(msg)=>sendMsg(msg)}/>
